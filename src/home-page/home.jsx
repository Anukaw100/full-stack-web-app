  ...
  return (
    <main>
      <section>
        ...
        <div className="card product-card">
          <div className="card-content">
            ...
            <p className="card-body">Try out a demo of our parking solution!
          </p>
      ...
      <section className="light-section">
        <div className="card ai-card">
          <div className="card-content">
            ...
            <p className="card-body">AI are helping us to solve real world
            problems.
          </p>
            <a href="/why-ai" className="button">Learn More</a>
          </div>
        </div>
        <div className="ai-info">
          <h1>Machine Learning is changing the world</h1>
          <p>Artifical Intelligence is getting smarter and better at helping us
      ...
      <div className="parking-info">
          ...
          <p>Parking is becoming more laborious every day as traffic increases.
        ...
        <div className="card parking-card">
          <div className="card-content">
            ...
            <p className="card-body">Cities are facing major problems with
