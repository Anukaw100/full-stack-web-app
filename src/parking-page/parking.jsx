        ...
        <div className="columns">
          ...
          <div className="col col-2">
            ...
            <p>
              ...
              parking spots which can put other drivers at risk. And not only
              does it cause stress and anger for the drivers behind the wheel
              but it also means that some are totally abandoning trips all
        ...
        <div className="columns">
          <div className="col col-3">
            ...
            <p>
              ...
              of parking areas. This solution presents several problems however
              as opportune land that could be used to construct parking lots is
              finite and expansion incurs considerable costs on the economy.
              Architectural constraints in the proposed area would also need to
              be accounted for, such as building around shops and roads. Hence,
              ...
              of a vehicle and transfer information based on cloud, wireless,
              and Internet of Things (IoT) devices. However, scaling this
              solution application to an expanded parking lot requires
              proportional investment to install new parking sensors and
              appropriate receivers. This could result in increased financial
              burden on the parking lot maintainer, due in part to the greater
              amount of equipment that needs maintenance after expansion.
            </p>
          </div>
          <div className="col col-1 col-bg">
            <p>
              The focus of our work is to let people know when and where a
              parking spot is available. This is done using a field in computer
              vision technology called "Object Detection".
            </p>
          </div>
        </div>
      </div>
